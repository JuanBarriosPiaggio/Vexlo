...
export default function About() {
  return (
    <section className="py-24 sm:py-32 relative bg-white">
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-slate-50 rounded-full blur-[120px] -z-10"></div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-start">
            ...
            <div className="flex flex-col items-center lg:items-start">
              <div className="relative w-48 h-48 rounded-full overflow-hidden border-4 border-slate-100 shadow-clean-lg mb-6 group">
                <Image
                  src="/me.jpeg"
              ...
              <h3 className="text-3xl font-bold text-slate-900 mb-2">Juan</h3>
              ...
              <a
                ...
                className="text-slate-400 hover:text-primary transition-colors mb-6 inline-block"
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-xl font-semibold text-slate-900 mb-4">Why You Can Trust Me With Your Automation Needs</h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 p-4 rounded-xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-primary/30 transition-all">
          ...
          <div className="mt-16 pt-12 border-t border-slate-100">
            <h4 className="text-xl font-semibold text-slate-900 mb-6 text-center">What Sets Me Apart</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="text-center p-6 rounded-xl bg-slate-50 border border-slate-100 hover:border-primary/30 transition-colors">
                  <div className="text-4xl font-bold text-primary mb-2">{stat.val}</div>
                  <div className="text-slate-900 font-medium">{stat.label}</div>
                  <div className="text-slate-500 text-sm mt-2">{stat.sub}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Testimonial Quote */}
          <div className="mt-16 p-8 rounded-2xl bg-slate-50 border border-slate-100 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-2 h-full bg-primary"></div>
            <blockquote className="text-lg text-slate-600 italic mb-4 relative z-10">
            ...
            <p className="text-sm font-semibold text-slate-900">— David De Villiers, Former Colleague</p>
          </div>

          {/* Commitment Section */}
          <div className="mt-12 p-8 rounded-2xl bg-white border border-slate-100 shadow-clean-lg relative">
